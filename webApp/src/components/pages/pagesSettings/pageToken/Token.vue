<template>
    ...
    <div class="mt-10 flex w-full flex-col items-center gap-2">
        <button @click="hadleCopyText" @mousedown="handleLongPressItemStart" @mouseup="handleLongPressItemEnd"
        ...
        <span class="text-sm w-full bg-black/20 rounded-3xl p-2 text-white/80">{{ message }} </span>
    </div>
