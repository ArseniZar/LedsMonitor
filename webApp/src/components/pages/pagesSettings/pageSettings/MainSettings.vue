<template>
    ...
    <div  v-if="itemsCurrentChat" class="mt-7 w-full  h-full flex items-center gap-1 flex-col  rounded-xl">
        <img :src="'/public/img/icons8-device-100.png'" alt="Check" class="h-20" />
...
export default defineComponent({
    ...
    data(): {
        ...
        return {
            itemsChat: [
                { id: 1, imgIcon: '/public/img/icons8-chat-24.png', title: 'chat1' },
            ...
            itemDevice: {
                id: 1, imgIcon: '/public/img/icons8-device-48.png', title: 'Device'
            },
            itemsConf: [
                { id: 0, imgIcon: '/public/img/icons8-key-64.png', title: 'Token' },
                { id: 0, imgIcon: '/public/img/icons8-data-64.png', title: 'Data' },
            ]
