<template>
    ...
    <div  v-if="itemsCurrentChat" class="mt-7 w-full  h-full flex items-center gap-1 flex-col  rounded-xl">
        <img src="../../../../img/icons8-device-100.png" alt="Check" class="h-20" />
...
export default defineComponent({
    ...
    data(): {
        ...
        return {
            itemsChat: [
                { id: 1, imgIcon: '../../../../img/icons8-chat-24.png', title: 'chat1' },
            ...
            itemDevice: {
                id: 1, imgIcon: '../../../../img/icons8-device-48.png', title: 'Device'
            },
            itemsConf: [
